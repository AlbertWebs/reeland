        ...
        <div class="sb2-2">
            <div class="sb2-2-2">
                <ul>
                    ...
                    <li class="active-bre"><a href="#"> Edit {{$Service->name}}</a>
                    </li>
                        ...
                        <form method="POST" action="{{url('/')}}/admin/edit_Service/{{$Service->id}}" enctype="multipart/form-data">
                            ...
                            <div class="row">
                                <div class="input-field col s12">
                                    <input autocomplete="off" name="title" id="list-title" value="{{$Service->title}}" type="text" class="validate" required>
                                ...
                                <div class="">
                                    <div class="input-field col s3 col-lg-3">
                                        <div class="form-group">
                                            ...
                                            <img class="image-preview" style="width:100%" src="{{url('/')}}/uploads/services/{{$Service->image}}"/>
                                        </div>
                                    </div>
