    ...
    <div class="container">
      ...
      <div class="row">
        ...
        <div class="listing_full">
              <div class="image">
                <img alt="image" src="{{asset('theme/images/b-d-property.jpg')}}">
        ...
        <div class="listing_full">
              <div class="image">
                <img alt="image" src="{{asset('theme/images/b-d-property2.jpg')}}" >
                <span class="tag_t">For Sale</span>
              </div>
              <div class="listing_full_bg">
                <div class="listing_inner_full">
        ...
        <div class="listing_full">
              <div class="image">
                <img alt="image" src="{{asset('theme/images/b-d-property3.jpg')}}" >
                <span class="tag_t">For Sale</span>
              </div>
              <div class="listing_full_bg">
                <div class="listing_inner_full">
        ...
        <div class="listing_full">
              <div class="image">
                <img alt="image" src="{{asset('theme/images/b-d-property4.jpg')}}" >
                <span class="tag_t">For Sale</span>
              </div>
              <div class="listing_full_bg">
                <div class="listing_inner_full">
          ...
          <div class="item">
            <div class="property_item">
              ...
              <div class="proerty_content">
                ...
                <div class="proerty_text">
                  <p>Lorem ipsum dolor sit amet, consectetuer adipiscing elit, sed diam power nonummy nibh tempor cum soluta nobis …</p>
                </div>
                <div class="favroute clearfix">
