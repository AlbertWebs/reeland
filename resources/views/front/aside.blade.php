      ...
      <form class="callus">
        ...
        <div class="single-query form-group col-sm-12">
          <div class="intro">
            <div class="single-query form-group">
                <input type="text" class="keyword-input" placeholder="Location">
              </div>
          </div>
        </div>
        <div class="single-query form-group col-sm-12">
        ...
        <div class="col-sm-12">
          <div class="row">
            <div class="col-sm-6">
              <div class="single-query form-group">
                <input type="text" class="keyword-input" placeholder="Min Price (sq ft)">
              </div>
            </div>
            <div class="col-sm-6">
              <div class="single-query form-group">
                <input type="text" class="keyword-input" placeholder="Max Price (sq ft)">
              </div>
            </div>
          </div>
        </div>
